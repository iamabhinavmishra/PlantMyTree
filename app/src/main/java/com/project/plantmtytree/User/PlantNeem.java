...
public class PlantNeem extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_plant_neem);

        mAuth = FirebaseAuth.getInstance();



        OddName = findViewById(R.id.user_name_neem);
        OddPhone = findViewById(R.id.user_phone_neem);
        OddEventName = "Direct";
        OddEventId = "Null";
        OddPlantName = "Neem Tree";
        OddPlantPrice = "300";
