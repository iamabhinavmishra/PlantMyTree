...
public class PlantSal extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_plant_sal);

        mAuth = FirebaseAuth.getInstance();



        OddName = findViewById(R.id.user_name_sal);
        OddPhone = findViewById(R.id.user_phone_sal);
        OddEventName = "Direct";
        OddEventId = "Null";
        OddPlantName = "Sal Tree";
        OddPlantPrice = "200";
