...
public class PlantPeepal extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_plant_peepal);

        mAuth = FirebaseAuth.getInstance();



        OddName = findViewById(R.id.user_name_peepal);
        OddPhone = findViewById(R.id.user_phone_peepal);
        OddEventName = "Direct";
        OddEventId = "Null";
        OddPlantName = "Peepal Tree";
        OddPlantPrice = "400";
