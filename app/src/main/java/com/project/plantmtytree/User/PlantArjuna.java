...
public class PlantArjuna extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_plant_arjuna);

        mAuth = FirebaseAuth.getInstance();



        OddName = findViewById(R.id.user_name_arjuna);
        OddPhone = findViewById(R.id.user_phone_arjuna);
        OddEventName = "Direct";
        OddEventId = "Null";
        OddPlantName = "Arjuna Tree";
        OddPlantPrice = "300";
